 ...
 * @author LENOVO
 */
public class frmTambahKeberangkatan extends javax.swing.JDialog {

    /**
     * Creates new form frmTambahKeberangkatan
     */
    public frmTambahKeberangkatan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        this.setLocationRelativeTo(null); 
        initComponents();
        this.setTitle("Tambah Keberangkatan");
        Keberangkatan k = new Keberangkatan();
        txtKdKeberangkatan.setText(k.id_otomatis());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Kode Keberangkatan :");

        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel2.setText("Nama Keberangkatan :");
    ...
    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
        // TODO add your handling code here:
        Keberangkatan k = new Keberangkatan();
        k.tambah_keberangkatan(new Keberangkatan(txtKdKeberangkatan.getText(),
                                txtKeberangkatan.getText(),txtAlamat.getText()));
        JOptionPane.showMessageDialog(null, "Data Keberangkatan Berhasil Disimpan.");
        setVisible(false);
    ...
    private javax.swing.JTextField txtKdKeberangkatan;
